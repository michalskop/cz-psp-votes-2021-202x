...
for interval in intervals:
    ...
    # attendance
    attendance = pd.pivot_table(valid_votes_interval, index=['mp_id'], columns=['vote'], values=['vote_event_id'], aggfunc='count', fill_value=0)
    ...
    output.to_csv(path + data_path + "partly/attendance_" + interval['name'] + ".v1.csv", index=False)
